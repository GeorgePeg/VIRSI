...
_In case you want to supply the VRM V3 with 5V, you will have to use the voltage divider because the **pins of the ESP32-S3 are not 5V tolerant**._You will have to reduce the voltage down to 3.3V.
